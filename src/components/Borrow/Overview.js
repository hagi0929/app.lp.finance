        ...
        <div className="col-lg-11 col-md-11 col-12">
          <div className="row py-2">
            <div className="col-lg-4 col-md-4 col-sm-6 col-12">
              <div className="overview_title ml-lg-4 pl-lg-4 pl-md-4 pl-sm-4 pl-0">
          ...
          <div className="row d-flex justify-content-center overview_card">
