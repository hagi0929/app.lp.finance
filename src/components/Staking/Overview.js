        ...
        <div className="col-lg-11 col-md-11 col-12">
          ...
          <div className="overview_card d-flex flex-row">
            ...
            <Card
              ...
              br="20px"
              p="2rem 1.5rem"
              className="details_card ml-lg-4 ml-md-4 ml-sm-3 ml-0"
            >
              <div className="row d-flex align-items-center justify-content-center">
                <div className="col-lg-6 col-md-8 col-12 card_left mt-lg-0 mt-md-0 mt-4 d-flex justify-content-lg-center justify-content-md-center justify-content-start">
                ...
                <div className="col-lg-6 col-md-8 col-12 card_right mt-lg-0 mt-md-0 mt-4 d-flex justify-content-lg-center justify-content-md-center justify-content-start">
                  <div className="list_section p-lg-3 p-md-2">
                    <table>
                      <tbody>
                        <tr>
